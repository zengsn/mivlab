...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function updbt(id){
				...
				success:function(data){	
					...
					$("#gupassword").textbox('setValue',ob.upassword);
				}
			});
		}
		//保存
		function gltj(){
			...
			var upassword=$("#gupassword").textbox('getValue');
			var id=$("#idi").val();
			var flag=$("#flagi").val();
			if(uname==""||upassword==""){
				alert('管理员信息不完整。');
		...
		//查询
		function cktj(){
			var sqls="select  admin.* from  admin where 1=1 ";
			var un=$("#ckuname").textbox('getValue');
			if(un!=""){
				sqls+=" and uname like '%"+un+"%'";
			}
			$.ajax({
				url:'CkSvlt',
				type:'post',
				...
				<tr>
					...
					<td style="padding-right:10px;"><div align="right" style="padding-right: 50px;">
						<table border="0" align="right" cellpadding="0" cellspacing="0">
							<tr>
								<td class="STYLE3">
									账号：<input id="ckuname" class="ckinput easyui-textbox"/>
								</td>
								<td width="60">
							...
							<td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
								...
								<c:forEach var="a" items="${alist }">
									<tr>
										...
										<td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3">${a.upassword }</span></div></td>
										...
										<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td><table border="0" align="right" cellpadding="0" cellspacing="0">
													<tr>
														<td width="40"><a href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','admin');return false;"><img src="images/first.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','admin');return false;"><img src="images/back.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','admin');return false;"><img src="images/next.gif" width="37" height="15"/></a></td>
														<td width="40"><a href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','admin');return false;"><img src="images/last.gif" width="37" height="15"/></a></td>
			...
			<td style="width: 100%;" align="center">
				<div id="dlg" class="easyui-dialog" title=" "  style="width:100%;max-width:400px;padding:30px 60px;">
					<form id="ff" method="post">
						...
						<div style="margin-bottom:20px">
							<input id="gupassword" class="easyui-textbox" name="gupassword" style="width:100%"  data-options="label:'密码:'"/>
						</div>
					</form>
