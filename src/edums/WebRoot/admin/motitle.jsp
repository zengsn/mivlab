...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function updbt(id){
				...
				success:function(data){	
					...
					$("#dlg").dialog('open');
					$("#dlg").dialog({modal:true});
					$("#gotname").textbox('setValue',ob.otname);
				}
			});
		}
		//保存
		function gltj(){
			var otname=$("#gotname").textbox('getValue');
			var id=$("#idi").val();
			var flag=$("#flagi").val();
			if(otname==""){
				alert('一级标题信息不完整。');
			...
			if("add"==flag){
				$.ajax({
					url:'AddSvlt',
					type:'post',
					data:{"tbname":"otitle","otname":otname},
					dataType:'json',
					success:function(data){
						alert(data.msg);
					}
				...
				$.ajax({
					url:'UpdSvlt',
					type:'post',
					data:{"tbname":"otitle","id":id,"otname":otname},
					dataType:'json',
					success:function(data){
						alert(data.msg);
					}
		...
		//取消
		function rst(){
			window.location.href="InitSvlt?tbname=otitle";
		}
		//查询
		function cktj(){
			var sqls="select  otitle.* from  otitle where 1=1 ";
			var un=$("#ckuname").textbox('getValue');
			if(un!=""){
				sqls+=" and otname like '%"+un+"%'";
			}
			$.ajax({
				url:'CkSvlt',
				type:'post',
							...
							<td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
								...
								<c:forEach var="a" items="${alist }">
									<tr>
										...
										<td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3">${a.otname }</span></div></td>
										...
										<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td><table border="0" align="right" cellpadding="0" cellspacing="0">
													<tr>
														<td width="40"><a href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','otitle');return false;"><img src="images/first.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','otitle');return false;"><img src="images/back.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','otitle');return false;"><img src="images/next.gif" width="37" height="15"/></a></td>
														<td width="40"><a href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','otitle');return false;"><img src="images/last.gif" width="37" height="15"/></a></td>
