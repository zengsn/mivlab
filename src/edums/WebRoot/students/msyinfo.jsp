...
<html>
	<head>
		...
		//查询
		function cktj(){
			var sqls="select syinfo.*,termname,classname,cname,tname from courseplan,syinfo,classinfo,course,teacher,terms where classinfo.id=courseplan.classinfo_id and terms_id=terms.id and courseplan.id=courseplan_id and courseplan.teacher_id=teacher.id and  course.id=course_id ";
			...
			$.ajax({
				...
				success:function(data){
					if(data.msg==1){
						window.location.href="InitSvlt?tbname=stusyinfo";
					}else{
						alert(data.msg);
					}
				}
										...
										<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td><table border="0" align="right" cellpadding="0" cellspacing="0">
													<tr>
														<td width="40"><a href="javascript:void(0);" onclick="sybtdown('PagingSvlt?flag=1','stusyinfo');return false;"><img src="images/first.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="javascript:void(0);" onclick="syybtdown('PagingSvlt?flag=2','stusyinfo');return false;"><img src="images/back.gif" width="37" height="15"/></a></td>
														<td width="45"><a href="javascript:void(0);" onclick="xyybtdown('PagingSvlt?flag=3','stusyinfo');return false;"><img src="images/next.gif" width="37" height="15"/></a></td>
														<td width="40"><a href="javascript:void(0);" onclick="wybtdown('PagingSvlt?flag=4','stusyinfo');return false;"><img src="images/last.gif" width="37" height="15"/></a></td>
