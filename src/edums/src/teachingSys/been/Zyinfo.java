...
public class Zyinfo
{
	...
	private  int syinfo_id;
	public int getSyinfo_id(){
		return syinfo_id;
	}
	public void setSyinfo_id(int syinfo_id){
		this.syinfo_id=syinfo_id;
	}
	...
	public String getSymark(){
		return symark;
	}
	public void setSymark(String symark){
		this.symark=symark;
	}
	...
	public String getZyword(){
		return zyword;
	}
	public void setZyword(String zyword){
		this.zyword=zyword;
	}
}