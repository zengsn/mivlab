...
function cktj(){
	...
	var sqls="select "+tbname+".*,students.sname, terms.termname,course.cname,classinfo.classname from "+tbname+",students,course,terms,classinfo  where classinfo.id=students.classinfo_id and students.sno=Num and course_id=course.id and "+tbname+".terms_id=terms.id and tid= "+userid;
