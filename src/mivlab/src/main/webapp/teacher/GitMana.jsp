...
function submitGitdate(){
	...
	$.ajax({
		...
		type:'post',
		data:{"org":org,"proj":proj,"cktermsid":cktermsid,"ccoursesid":ccoursesid,"pulls":pulls,"pullsFull":pullsFull,"commits":commits,"commitsFull":commitsFull,"files":files,"filesFull":filesFull,"comments":comments,"commentsFull":commentsFull,"flgs":"in"},
		dataType:'json',
