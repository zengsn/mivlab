...
function submitGitdate(){
	...
	$.ajax({
		...
		type:'post',
		data:{"org":org,"proj":proj,"cktermsid":cktermsid,"ccoursesid":ccoursesid,"pulls":pulls,"pullsFull":pullsFull,"commits":commits,"commitsFull":commitsFull,"files":files,"filesFull":filesFull,"comments":comments,"commentsFull":commentsFull,"flgs":"out"},
		dataType:'json',
		success:function(data){			
				alert(data.msg);
				if(data.msg=="所有数据更新完毕"){
					window.location.href="<%=basePath %>GetDataSvlt?tbname=tGitDate2&org="+org+"&proj="+proj;
				}			
		}
	});
}
...
<header class="am-topbar am-topbar-fixed-top">	
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">系外教学--Git实验管理</h4></li>
				</ul>
						    ...
						    <li class="admin-parent">
						     ...
						     <li class="admin-parent">
						      ...
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav2">
						        <li><a href="<%=basePath %>InitSvlt?flgs=1&tbname=tGitmana2&f=2" class="am-cf"> GitHub实验管理</span></a></li>
						        <li><a href="<%=basePath %>InitSvlt?flgs=1&tbname=tGitDate2&f=2"> 实验成绩</span></a></li>
